...
Refer to the [Installation Documentation](/docs/get-started/installation) to complete the installation. And check that the components of Fluid are running normally (here takes JuiceFSRuntime as an example):
