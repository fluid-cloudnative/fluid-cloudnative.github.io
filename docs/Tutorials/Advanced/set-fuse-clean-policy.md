---
sidebar_label: Set FUSE Clean Policy
sidebar_position: 6
---
...
Before running this example, please refer to the [Installation Documentation](/docs/get-started/installation) to complete the installation, and check that each Fluid component is normal run:
